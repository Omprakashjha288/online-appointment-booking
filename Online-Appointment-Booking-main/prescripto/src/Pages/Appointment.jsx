    ...
    docInfo && (
      <div>
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          {/* --- Doc Info : name, degree, specility, experience--- */}
          <div className="flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0">
            ...
            {/* ------Doctors About ----- */}
            <div>
              <p className="flex items-center gap-1 text-sm font-medium mt-3 text-gray-950 ">
        ...
        <div className="sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700">
          ...
          <button className="bg-primary text-white rounded-full text-sm font-light px-14 py-3 my-6">
            Book an Appointment
          </button>
        </div>
